...
export function ArtistRow({ artist }: { artist: Artist }) {
  ...
  return (
    <div
      className="grid grid-cols-12 gap-4 px-4 py-3 hover:bg-base-300/50 transition-colors duration-150 group border-b border-base-200 last:border-b-0 cursor-pointer"
